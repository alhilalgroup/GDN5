jQuery(document).ready(function () {
    ...
    jQuery.getJSON('http://cdn.gdnonline.com/classifiedsections/?jsoncallback=?', function (data) {
        jQuery.each(data, function (key, value) {
            contenthtml += '<img onclick=window.location.href="classifieds.html?id=' + data[key].SectionID + '" style="float:left; margin:5px 5px 0 0" src="http://www.gdnonline.com/images/icons/' + data[key].SectionID + '.png"> <div class="oswald" style="color:black;float:left;font-size:15px;margin:25px 0 0 0"  onclick=window.location.href="classifieds.html?id=' + data[key].SectionID + '">' + data[key].SectionName + ' </div><br style="clear:both">';
